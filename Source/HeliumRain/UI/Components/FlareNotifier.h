...
public:
	...
	bool Notify(FText Text, FText Info, FName Tag, EFlareNotification::Type Type, float NotificationTimeout, EFlareMenu::Type TargetMenu, FFlareMenuParameterData TargetInfo = FFlareMenuParameterData());
